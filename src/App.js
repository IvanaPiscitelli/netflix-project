...
import Movie from "./components/Movies/Movies/Movie";
  ...
  return (
    <main>
      <Carousel
        ...
        infinite
        customTransition="transform 330ms ease-out 50ms"
        customLeftArrow={style.leftArrow}
        customRightArrow={style.rightArrow}
      >
